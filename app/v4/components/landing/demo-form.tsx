            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-x-4 top-[50%] z-[61] mx-auto max-w-lg -translate-y-1/2 overflow-hidden rounded-2xl border border-border bg-card shadow-2xl shadow-black/60"
                    ...
                    >
                        ...
                        {/* Footer trust */}
                        {status !== "success" && (
                            <div className="flex items-center justify-center gap-5 border-t border-border bg-surface px-5 py-3">
