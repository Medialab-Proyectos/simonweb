...
const testimonials = [
  ...
  {
    quote:
      "La alerta de documentos del vehículo me salvó de una multa. Me llegó el aviso del SOAT a punto de vencer y lo renové a tiempo. Pequeño detalle, gran impacto.",
    author: "Andrés Mejía",
  ...
  {
    quote:
      "Me varé en la vía al Llano con un pinchazo de noche. Llamé al #280 desde Simon y en menos de 25 minutos ya tenía la grúa al lado. Eso es lo que necesitas cuando estás solo en carretera.",
    author: "Juan Camilo Pérez",
    role: "Usuario particular, Villavicencio",
    initials: "JP",
          ...
          <figure className="relative overflow-hidden rounded-2xl border border-border shadow-sm h-64 w-full sm:h-80">
            ...
            <figcaption className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent px-5 py-4">
              <p className="text-sm font-medium text-white">
                Más de 44.000 vehículos monitoreados en Colombia
              </p>
            </figcaption>
          </figure>
        </motion.div>
          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <figcaption className="mt-6 flex items-start gap-3">
                <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-sm font-bold ${t.avatarColor}`}>
                  {t.initials}
                </div>
