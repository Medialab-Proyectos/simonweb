...
const footerLinks = {
  ...
  empresa: [
    { label: "Para personas",   href: "#soluciones-grid" },
    { label: "Para empresas",   href: "#demo" },
    { label: "Cómo funciona",   href: "#como-funciona" },
    { label: "Casos de éxito",  href: "#testimonios" },
    { label: "Preguntas",       href: "#faq" },
  ],
  legal: [
    { label: "Privacidad y tratamiento de datos", href: "/privacidad" },
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="mb-12 flex flex-col items-center text-center">
          ...
          <address className="mt-5 not-italic flex flex-wrap items-center justify-center gap-5">
            ...
            <span className="flex items-center gap-2 text-sm text-muted-foreground select-all">
              <Hash className="h-4 w-4 shrink-0" aria-hidden="true" />
              Soporte: <kbd className="font-mono font-semibold">#230</kbd>
              <span className="text-border">·</span>
              Asistencia vial: <kbd className="font-mono font-semibold">#280</kbd>
            </span>
            <a
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row">
          ...
          <div className="flex gap-4" aria-label="Redes sociales">
            <a href="https://www.facebook.com/SimonMovilidad/" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.linkedin.com/company/simon-movilidad/" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://tiktok.com/@simonmovilidad" target="_blank" rel="noopener noreferrer"
              className="text-muted-foreground hover:text-primary transition-colors" aria-label="Simon Movilidad en TikTok">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z" />
              </svg>
            </a>
            <a href="https://youtube.com/@simonmovilidad" target="_blank" rel="noopener noreferrer"
              className="text-muted-foreground hover:text-primary transition-colors" aria-label="Simon Movilidad en YouTube">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
