            ...
            >
              <figure className="relative overflow-hidden rounded-2xl border border-border shadow-sm h-64 w-full sm:h-80">
                {segment === "personas" ? (
                  <video
                    key="video-personas"
                    src="/videos/services/monitoreo.mp4"
                    autoPlay
                    loop
                    muted
                    playsInline
                    poster="/images/product-showcase-new.png"
                  ...
                  <video
                    key="video-empresas"
                    src="/videos/services/reportes.mp4"
                    autoPlay
                    loop
                    muted
                    playsInline
                    poster="/images/product-showcase-new.png"
                    className="h-full w-full object-cover"
                    aria-label="Administrador de flota monitoreando vehículos desde la plataforma Simon"
                  />
                )}
              </figure>
            </motion.div>
